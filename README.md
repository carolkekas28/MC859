...
2.  **Análise de Centralidade:** Identificação da dominância semântica e posição topológica dos radicais.
...
## Origem dos Dados
* **Estrutura:** Unihan Database (`Unihan_IRGSources.txt` e `Unihan_Readings.txt`).
...
| Construção do Grafo e Métricas | 24/04 | ⏳ |
